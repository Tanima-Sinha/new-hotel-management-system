...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="btn-group">
                <asp:Button ID="btnconfirmroom" runat="server" CssClass="btn" Text="Confirm Room Booking" />
                <asp:Button ID="btncancelroom" runat="server" CssClass="btn" Text="Cancel Room Booking" />
            </div>
        </div>
    </form>
</body>
